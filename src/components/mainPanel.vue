<template>
  <div class="mainPanel d-flex flex-column align-items-center">
    ...
    <div class="cont-cat">
      ...
      <div @click.prevent="searchCat('Apparel')" class="category btn-primary d-flex align-items-center justify-content-center">Vegetable</div>
      <div @click.prevent="searchCat('Automotive')" class="category btn-primary d-flex align-items-center justify-content-center">Herb</div>
    </div>
  </div>
</template>
